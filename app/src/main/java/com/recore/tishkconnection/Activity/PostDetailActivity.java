...
public class PostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nestedScrollViewRoot=(NestedScrollView)findViewById(R.id.nestedScrollView);

        imgPost =(ImageView)findViewById(R.id.post_detail_image);
        imgUserPost =(CircleImageView)findViewById(R.id.post_detail_user_img);
        imgCurrentUser=(CircleImageView)findViewById(R.id.post_detail_currentuser_img);

        txtPostTitle =(TextView)findViewById(R.id.post_detail_title);
        txtPostDescription=(TextView)findViewById(R.id.post_detail_desc);
        txtPostDate=(TextView)findViewById(R.id.post_detail_date_name);

        editTextComment=(EditText)findViewById(R.id.post_detail_comment_edit_text);

        btnAddComment =(Button)findViewById(R.id.post_detail_add_comment_button);
